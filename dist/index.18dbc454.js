...
fetch("https://mmaximova.dk/wp-json/jwt-auth/v1/token", {
    ...
    fetch(`${baseUrl}?status=private&categories=3&per_page=40`, {
        ...
        $(document).ready(function() {
            ...
            for(var s = 0; s < totalPages; s++)nav += '<li><a class="pagination-numbers text-bold numbers" href="#">' + (s + 1) + "</a></li>";
            $(".page-prev").after(nav);
            $(".numbers").first().addClass("active");
            showPage = function() {
                $(".staff-page").hide().each(function(n) {
                    if (n >= pageSize * (currentPage - 1) && n < pageSize * currentPage) $(this).show();
                });
            };
            showPage();
            ...
            console.log(chunks);
            const staffPage1 = chunks[0].map((chunks)=>`<li class="d-grid staff-grid">
            ...
            const staffPage2 = chunks[1].map((chunks)=>`<li class="d-grid staff-grid">
                        <img src="${chunks.acf.staff_image.url}"alt="${chunks.acf.staff_image.alt}" class="img-150"/>
                        <div class="align-self-center full-width">
                            <h2 class="heading-golden h2-golden-underline">${chunks.acf.staff_name}</h2>
                            <h4 class="heading-white">${chunks.acf.staff_position}</h4>
            ...
            const staffPage3 = chunks[2].map((chunks)=>`<li class="d-grid staff-grid">
                        <img src="${chunks.acf.staff_image.url}"alt="${chunks.acf.staff_image.alt}" class="img-150"/>
                        <div class="align-self-center full-width">
                            <h2 class="heading-golden h2-golden-underline">${chunks.acf.staff_name}</h2>
                            <h4 class="heading-white">${chunks.acf.staff_position}</h4>
            ...
            const staffPage4 = chunks[3].map((chunks)=>`<li class="d-grid staff-grid">
                        <img src="${chunks.acf.staff_image.url}"alt="${chunks.acf.staff_image.alt}" class="img-150"/>
                        <div class="align-self-center full-width">
                            <h2 class="heading-golden h2-golden-underline">${chunks.acf.staff_name}</h2>
                            <h4 class="heading-white">${chunks.acf.staff_position}</h4>
...
},{"bootstrap":"h36JB","@popperjs/core":"7unqC"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gEwwu","1SICI"], "1SICI", "parcelRequire95e4")
